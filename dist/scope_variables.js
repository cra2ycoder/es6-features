...
function doTestScopeVariables() {
  ...
  console.log('var: ' + a); // const value will not be printed here, local variable will be taken
...
function doTestVarAndLetInReturn(isFlag) {
  ...
  if (isFlag) {
    var _m = 1;
    console.log('isFlag:true -> m: ' + _m); // 1
...
console.log('return -> n:' + n); // if inner var m; is enabled then -> undefined else 0
